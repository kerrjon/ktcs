namespace Ktcs.DataModel.Migrations
{
  ...
  public partial class Majorupdate : DbMigration
  {
    ...
    {
      // manually added this first ones
      DropForeignKey("dbo.CourseType", "FK_CourseType_area");
      DropForeignKey("dbo.Course", "FK_Course_CourseTypeDetail");
      DropForeignKey("dbo.Course", "FK_Course_BasePrice");
      DropForeignKey("dbo.CourseTypeDetail", "FK_CourseTypeDetail_CourseType");
      //end of manual
